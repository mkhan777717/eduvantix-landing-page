      ...
      <section className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6 border-b pb-6 mb-6 shrink-0 relative" style={{ borderColor: "var(--border-primary)" }}>
        <div className="space-y-2">
          ...
          <p className="text-sm max-w-xl" style={{ color: "var(--text-secondary)" }}>
            Manage internal job postings, review candidate applications, and configure hiring workflows.
          </p>
        </div>
        {activeTab === "jobs" && (
          <button
            onClick={openAddJob}
            className="flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl text-white text-xs font-semibold transition-transform hover:-translate-y-0.5 cursor-pointer shadow-md shrink-0 self-start sm:self-auto"
        ...
        <div className="space-y-3">
          {jobs.length === 0 ? (
            <div className="flex flex-col items-center justify-center p-12 text-center rounded-3xl border border-dashed"
              ...
              <h3 className="text-base font-bold" style={{ color: "var(--text-primary)" }}>No jobs posted yet</h3>
              <p className="text-xs max-w-sm mt-1.5 leading-relaxed" style={{ color: "var(--text-secondary)" }}>
                Create internal job openings to start accepting and reviewing candidate applications.
              </p>
              <button
                onClick={openAddJob}
